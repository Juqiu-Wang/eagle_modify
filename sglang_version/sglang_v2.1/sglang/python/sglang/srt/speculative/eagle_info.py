...
class EagleVerifyInput(SpecInput, EagleVerifyInputV2Mixin):
    ...
    # [Dynamic Steps v2] Actual draft steps used (for logging), may differ from spec_steps
    actual_spec_steps: int = -1
    ...
    def verify(
        ...
        if batch.forward_mode.is_idle():
            return EagleVerifyOutput(
                ...
                spec_steps=self.actual_spec_steps if self.actual_spec_steps >= 0 else self.spec_steps,
            )
...
class EagleVerifyOutput:
    ...
    # [Dynamic Steps] The actual spec steps used in this verify batch
    spec_steps: int = 0
